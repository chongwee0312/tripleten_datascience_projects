...
model_path = os.path.join(current_dir, 'models', 'project_14_spacy_tfidf_lr.pkl')
vectorizer_path = os.path.join(current_dir, 'models', 'project_14_spacy_tfidf_vectorizer.pkl')
...
if st.button('Submit my movie review'):
    ...
    if pred == 1.0:
        ...
        st.markdown(f'Sorry to hear that the movie ***{movie}*** didn\'t meet your expectations.😢 Thanks for sharing your thoughts!')
